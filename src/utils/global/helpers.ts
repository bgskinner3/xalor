...
import { isString, ObjectUtils } from '../../../shared';
...
export function executeVaultSelfHealingSeeding(
  ...
  try {
    ...
    const candidatePaths: string[] = [
      fsContext.resolvePath('../../../xalor-vault.json'),
      fsContext.resolvePath('../../../../xalor-vault.json'),
      fsContext.resolvePath('../../../../../xalor-vault.json'),
      fsContext.resolvePath('./dist/xalor-vault.json'),
      fsContext.resolvePath('./dist-xalor/xalor-vault.json'),
      fsContext.resolvePath('./.xalor/xalor-vault.json'),
      fsContext.resolvePath('./xalor-vault.json'),
      fsContext.resolvePath('./xalor-vault.json'),
    ];
    ...
    for (let i = 0; i < totalCandidates; i++) {
      ...
      /* prettier-ignore */
      // if (isString(currentCandidate) && fs.existsSync(currentCandidate)) {
      if (isString(currentCandidate) && fsContext.fileExists(currentCandidate)) {
